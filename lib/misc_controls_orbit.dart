...
class _MyAppState extends State<MiscControlsOrbit> {
  ...
  Future<void> initPlatformState() async {
    ...
    Map<String, dynamic> options = {"antialias": true, "alpha": true, "width": width.toInt(), "height": height.toInt(), "dpr": dpr};
  ...
  initRenderer() {
    Map<String, dynamic> options = {"width": width, "height": height, "gl": three3dRender.gl, "antialias": true, "canvas": three3dRender.element, "alpha": true};
  ...
  initPage() {
    scene = three.Scene();
    // scene.background = three.Color(0xcccc00);
    ...
    var material = three.MeshPhongMaterial({"color": 0xfff77f, "flatShading": true});
